...
var DateTimePicker = function DateTimePicker(props) {
  ...
  var renderDatesListing = function renderDatesListing(day) {
    ...
    return _react["default"].Children.toArray(matchedDates === null || matchedDates === void 0 ? void 0 : matchedDates.dates.map(function (dt) {
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "h-10 w-10 text-center transition-all rounded-md text-2xl pt-1.5 ".concat(dateTime.date === String(dt.date) && matchedDates.key.toLocaleLowerCase() === dateTime.day.toLocaleLowerCase() && _dateTime.Months[currentMonth] === dateTime.month && String(currentYear) === String(dateTime.year) && "bg-gray-400", " ").concat(dt.isDisabled ? "pointer-events-none text-gray-500" : "cursor-pointer hover:bg-gray-400")
  ...
  return show && /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "flex flex-wrap max-h-52 overflow-y-auto gap-3"
  }, _react["default"].Children.toArray(timeslots.map(function (time) {
    return /*#__PURE__*/_react["default"].createElement("div", {
      className: "".concat(dateTime.time === time && "bg-gray-400", " cursor-pointer hover:bg-gray-200 p-2 rounded-md text-xl"),
      onClick: function onClick() {
        setDateTime(function (prev) {
          return _objectSpread(_objectSpread({}, prev), {}, {
            time: time
